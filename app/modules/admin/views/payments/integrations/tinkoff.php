            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">Tinkoff Terminal Key<span class="form-required">*</span></label>
                    <input type="text" class="form-control" name="payment_params[option][terminal_key]" value="<?php echo (isset($option->terminal_key)) ? $option->terminal_key : ''; ?>">
                  </div>
