              ...
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="payment_params[option][publish_key]" value="<?php echo (isset($option->publish_key)) ? $option->publish_key : ''; ?>">
                  </div>

                  <div class="form-group">
                    <label class="form-label">Secrect Key<span class="form-required">*</span></label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-append">
                        <span class="input-group-text new_currency_code">TL</span>
                      </span>
                    </div>
                  </div>

                  <div class="form-group">
                    <p class="">Paywant Notify URL:
                      <span class="text-danger text-link"><?php echo cn('add_funds/paywant/cron'); ?></span>
                    </p>
                  </div>
