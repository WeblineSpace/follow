...
class order_model extends MY_Model 
{
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            ...
            $this->db->select('o.id, o.ids, o.type, o.service_type, o.service_id, o.api_provider_id, o.api_service_id, o.api_order_id, o.status, o.charge, o.formal_charge, o.profit, o.link, o.quantity, o.comments, o.remains, o.start_counter, o.created, o.note');
