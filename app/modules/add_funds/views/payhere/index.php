    ...
    <div class="row">
      <div class="col-md-12">
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/payhere.png" style="max-width: 250px;" alt="Payhere icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Payhere')?></small></p>
        </div>
        ...
        <div class="form-group">
          ...
          <ul>
            ...
            <?php } ?>
            <li><?=lang("Minimal_payment")?>: <strong><?php echo $min_amount; ?></strong>
            <?php
              if ($max_amount > 0) {
            ?>
