...
<div class="add-funds-form-content">
  <form class="form actionAddFundsForm" action method="POST">
    <div class="row">
      <div class="col-md-12">
        <?php 
          $currency_code = get_option("midtrans_country_currency_code", 'IDR');
        ?>
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/midtrans.png" style="max-width: 250px;" alt="midtrans icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'midtrans')?></small></p>
        </div>

        <div class="form-group">
          <label><?=sprintf(lang("amount_usd"), 'IDR')?></label>
        ...
        <div class="form-group">
          ...
          <ul>
            ...
            ?>
            <li><?=lang("currency_rate")?>: 1USD = <strong><?php echo $currency_rate_to_usd; ?></strong>IDR</li>
            <?php }?>
