    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/fondy.png" alt="Fondy icon" style="max-width:500px;">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Fondy')?></small></p>
        </div>
        ...
        <div class="form-group">
          ...
          <ul>
            ...
            <?php } ?>
            <li><?=lang("Minimal_payment")?>: <strong><?php echo $currency_code.$min_amount; ?></strong></li>
            <?php
              if ($max_amount > 0) {
            ?>
            <li><?=lang("Maximal_payment")?>: <strong><?php echo $currency_code.$max_amount; ?></strong></li>
            <?php } ?>
            <?php
