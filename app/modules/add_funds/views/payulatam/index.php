    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/payulatam.png" style="max-width: 250px;" alt="payulatam icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Payulatam')?></small></p>
        </div>

        <div class="form-group">
          <label><?php echo sprintf(lang("amount_usd"), $currency_code); ?></label>
