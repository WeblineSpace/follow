    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/paymongo.png" style="max-width: 250px;" alt="midtrans icon">
        ...
        <div class="form-group">
          <label><?=sprintf(lang("amount_usd"), 'PHP')?></label>
        ...
        <div class="form-group">
          ...
          <ul>
            ...
            ?>
            <li><?=lang("currency_rate")?>: 1USD = <strong><?php echo $currency_rate_to_usd; ?></strong>PHP</li>
            <?php }?>
