    ...
    <div class="row">
      <div class="col-md-12">
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/payzah.png" style="max-width: 250px;" alt="Payzah icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Payzah')?></small></p>
        </div>

        <div class="form-group">
          <label><?=sprintf(lang("amount_usd"), 'KWD')?></label>
          <input class="form-control square" type="text" name="amount" placeholder="<?php echo $min_amount; ?>">
        </div>

        <div class="form-group">
          <label class="form-label"  for="installments"><?php echo lang("please_choose_a_payment_type"); ?></label>
          <select class="form-control"  name="payment_option">
            <option value="1"> <?php echo lang("Knet"); ?> </option>
            <option value="2"> <?php echo lang("Credit_card"); ?> </option>
          </select>
        </div>                      
        ...
        <div class="form-group">
          ...
          <ul>
            ...
            <?php } ?>
            <li><?=lang("Minimal_payment")?>: <strong><?php echo $min_amount; ?></strong></li>
            <?php
              if ($max_amount > 0) {
            ?>
            <li><?=lang("Maximal_payment")?>: <strong><?php echo $max_amount; ?></strong></li>
            <?php } ?>
