    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="for-group text-center">
          <img src="<?=BASE?>/assets/images/payments/paystack.png" style="max-width: 250px;" alt="Paystack icon">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <ul>
              ...
              ?>
              <li><?=lang("currency_rate")?>: 1USD = <strong><?php echo $currency_rate_to_usd; ?></strong>NGN</li>
              <?php }?>
